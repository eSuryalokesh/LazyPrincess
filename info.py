...
API_ID = int(environ['22769885'])
API_HASH = environ['296388ef04ef84f20be22c3a62e3fc2b']
BOT_TOKEN = environ['7340544331:AAF8ybk-ALCSTGLDFVDWa2Q59hn_0_S8Qh4']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1583499573', '').split()]
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://srh429474:dxXqrIhIf72c7D8I@cluster0.dwmgxww.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")
